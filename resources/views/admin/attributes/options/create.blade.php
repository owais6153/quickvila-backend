...
@section('content')
    <div class="container-fluid">
        ...
        <form class="row" action="{{ route('attributeoption.store', ['attribute' => $attribute->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group align-items-center d-flex form-group">
                                    <div class="form-color">
                                        <input type="color" class="form-control" name="media" value="{{old('media')}}" placeholder="Variation Color*">
                                    </div>
